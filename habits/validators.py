...
class IsEnjoyableHabitValidator:
    def __call__(self, value):
        ...
        if not is_current_habit_enjoyable and related_habit and not related_habit.is_enjoyable:
